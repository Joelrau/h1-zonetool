...
namespace zonetool
{
	...
	enum $F11FA5CADBE10BF792F0EF20913A296A : __int32
	{
...
#pragma pack(pop)
	...
	namespace h2
	{
		...
		assert_offsetof(h2::XModel, numCompositeModels, 13);
		assert_offsetof(h2::XModel, compositeModels, 680);
		assert_offsetof(h2::XModel, contents, 576);
		assert_offsetof(h2::XModel, radius, 580);
		assert_offsetof(h2::XModel, materialHandles, 112);
		assert_offsetof(h2::XModel, lodInfo, 120);
